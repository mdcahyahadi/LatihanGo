...
var (
	FilePathPem = "infrastructure/certificates/star_ct_com.pem" // FilePathPem is a global const storing https certificate crt file
	FilePathKey = "infrastructure/certificates/ct.key"          // FilePathKey is a global const storing https certificate key file
)
