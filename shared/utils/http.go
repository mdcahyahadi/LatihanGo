...
const (
	MyGramHeaderUserID    string = "MyGram-User-Id"
	MyGramHeaderIPAddress string = "MyGram-Ip-Address"
	MyGramHeaderUserAgent string = "MyGram-User-Agent"
	MyGramHeaderTimeStamp string = "MyGram-Timestamp"
)
